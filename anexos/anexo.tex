...
\renewcommand{\thesection}{\Alph{section}}% Adjust section printing (from here onward)
	...
	\begin{landscape}
		...
		\begin{longtable}{ p{3.5cm}p{3.5cm}p{3.5cm}p{3cm}p{3cm}p{3cm}p{3cm} }
			...
			\cline{1-3}
			{\Pbone} & {\Objone} & {\Hone} & \multirow{6}{*}{{Dependiente: Diagnóstico de nódulos tiroideos Independiente: Modelo de Deep Learning}} & \multirow{6}{*}{{Tipo de Investigación: Experimental. Alcance de la investigación: Explicativo}} \\
			\cline{1-3}
